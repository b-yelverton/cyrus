...
- Cyrus Codex sessions now use the current bundled Codex runtime, allowing GPT-5.6 selections to execute instead of reporting an obsolete CLI. ([BYE-414](https://linear.app/byelverton/issue/BYE-414/cyrus-codex-instances-need-to-be-updated-to-have-gpt-56-model))
